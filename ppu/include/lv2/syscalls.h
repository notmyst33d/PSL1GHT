...
#define SYSCALL_PROCESS_GET_PARAMSFO                                30
#define SYSCALL_PROCESS_GET_PPU_GUID                                31

#define SYSCALL_PPU_THREAD_EXIT                                     41
...
#define SYSCALL_PPU_THREAD_STOP                                     50
#define SYSCALL_PPU_THREAD_RESTART                                  51
#define SYSCALL_PPU_THREAD_CREATE                                   52
#define SYSCALL_PPU_THREAD_START                                    53
...
#define SYSCALL_TRACE_CREATE                                        60
#define SYSCALL_TRACE_START                                         61
#define SYSCALL_TRACE_STOP                                          62
#define SYSCALL_TRACE_UPDATE_TOP_INDEX                              63
#define SYSCALL_TRACE_DESTROY                                       64
#define SYSCALL_TRACE_DRAIN                                         65
#define SYSCALL_TRACE_ATTACH_PROCESS                                66
...
#define SYSCALL_LWMUTEX_CREATE                                      95
#define SYSCALL_LWMUTEX_DESTROY                                     96
#define SYSCALL_LWMUTEX_LOCK                                        97
#define SYSCALL_LWMUTEX_UNLOCK                                      98
#define SYSCALL_LWMUTEX_TRYLOCK                                     99
...
#define SYSCALL_LWCOND_CREATE                                       111
#define SYSCALL_LWCOND_DESTROY                                      112
#define SYSCALL_LWCOND_QUEUE_WAIT                                   113

#define SYSCALL_SEMAPHORE_GET_VALUE                                 114 /* sem.h */

#define SYSCALL_LWCOND_SIGNAL                                       115
#define SYSCALL_LWCOND_SIGNAL_ALL                                   116
#define SYSCALL_LWMUTEX_UNLOCK2                                     117

#define SYSCALL_EVENT_FLAG_CLEAR                                    118

#define SYSCALL_TIME_GET_RTC                                        119
...
#define SYSCALL_TIME_SET_TIMEZONE                                   143
#define SYSCALL_TIME_GET_TIMEZONE                                   144
...
#define SYSCALL_SPU_IMAGE_GET_INFORMATION                           155
#define SYSCALL_SPU_IMAGE_OPEN                                      156
#define SYSCALL_SPU_IMAGE_IMPORT                                    157
#define SYSCALL_SPU_IMAGE_CLOSE                                     158
#define SYSCALL_SPU_IMAGE_GET_SEGMENTS                              159
...
#define SYSCALL_DBG_MAT_SET_CONDITION                               215
#define SYSCALL_DBG_MAT_GET_CONDITION                               216

#define SYSCALL_ISOLATED_SPU_CREATE                                 230
#define SYSCALL_ISOLATED_SPU_DESTROY                                231
#define SYSCALL_ISOLATED_SPU_START                                  232
#define SYSCALL_ISOLATED_SPU_CREATE_INTERRUPT_TAG                   233
#define SYSCALL_ISOLATED_SPU_SET_INT_MASK                           234
#define SYSCALL_ISOLATED_SPU_GET_INT_MASK                           235
#define SYSCALL_ISOLATED_SPU_SET_INT_STAT                           236
#define SYSCALL_ISOLATED_SPU_GET_INT_STAT                           237
#define SYSCALL_ISOLATED_SPU_SET_SPU_CFG                            238
#define SYSCALL_ISOLATED_SPU_GET_SPU_CFG                            239
#define SYSCALL_ISOLATED_SPU_READ_PUINT_MB                          240

#define SYSCALL_SPU_THREAD_GROUP_SYSTEM_SET_NEXT_GROUP              244
#define SYSCALL_SPU_THREAD_GROUP_SYSTEM_UNSET_NEXT_GROUP            245
#define SYSCALL_SPU_THREAD_GROUP_SYSTEM_SET_SWITCH_GROUP            246
#define SYSCALL_SPU_THREAD_GROUP_SYSTEM_UNSET_SWITCH_GROUP          247
...
#define SYSCALL_MEMORY_CONTAINER_CREATE_DBG                         324 /* memory.h */
#define SYSCALL_MEMORY_CONTAINER_DESTROY_DBG                        325 /* memory.h */

#define SYSCALL_MMAPPER_ALLOCATE_FIXED_ADDRESS                      326
#define SYSCALL_MMAPPER_ENABLE_PAGE_FAULT_NOTIFICATION              327
#define SYSCALL_MMAPPER_ALLOCATE_SHARED_MEMORY_FROM_CONTAINER_EXT   328
#define SYSCALL_MMAPPER_FREE_SHARED_MEMORY                          329
#define SYSCALL_MMAPPER_ALLOCATE_ADDRESS                            330 /* memory.h */
#define SYSCALL_MMAPPER_FREE_ADDRESS                                331 /* memory.h */
#define SYSCALL_MMAPPER_ALLOCATE_SHARED_MEMORY                      332
#define SYSCALL_MMAPPER_SET_SHARED_MEMORY_FLAG                      333
#define SYSCALL_MMAPPER_MAP_SHARED_MEMORY                           334
#define SYSCALL_MMAPPER_UNMAP_SHARED_MEMORY                         335
#define SYSCALL_MMAPPER_CHANGE_ADDRESS_ACCESS_RIGHT                 336
#define SYSCALL_MMAPPER_SEARCH_AND_MAP                              337 /* memory.h */
#define SYSCALL_MMAPPER_GET_SHARED_MEMORY_ATTRIBUTE                 338
#define SYSCALL_MMAPPER_ALLOCATE_SHARED_MEMORY_EXT                  339

#define SYSCALL_MEMORY_CONTAINER_CREATE                             341
#define SYSCALL_MEMORY_CONTAINER_DESTROY                            342
...
#define SYSCALL_MEMORY_GET_USER_MEMORY_STAT                         353
#define SYSCALL_MEMORY_ALLOCATE_COLORED                             356
#define SYSCALL_MEMORY_ALLOCATE_FROM_CONTAINER_COLORED              361

#define SYSCALL_MMAPPER_ALLOCATE_MEMORY_FROM_CONTAINER              362

#define SYSCALL_UART_INITIALIZE                                     367
#define SYSCALL_UART_RECEIVE                                        368
#define SYSCALL_UART_SEND                                           369
#define SYSCALL_UART_GET_PARAMS                                     370
